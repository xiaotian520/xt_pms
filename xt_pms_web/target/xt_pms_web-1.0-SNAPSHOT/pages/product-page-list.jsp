                            ...
                            <div class="pull-left">
                                <div class="form-group form-inline">
                                    <div class="btn-group">
                                        ...
                                        <button type="button" class="btn btn-default" title="刷新" onclick="location.href='${pageContext.request.contextPath}/product/findAll.do?page=1&size=5'"><i class="fa fa-refresh"></i> 刷新</button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                                ...
                                <tbody>
                                    <c:forEach items="${pageInfo.list}" var="product">
                                        <tr>
                                            <td class="text-center"><input name="ids" type="checkbox" value="${product.id}"></td>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <button type="button" class="btn bg-olive btn-xs" onclick="location.href='${pageContext.request.contextPath}/pages/product-detail.jsp'">详情</button>
