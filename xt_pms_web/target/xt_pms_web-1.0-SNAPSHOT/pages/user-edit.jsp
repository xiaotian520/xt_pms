					...
					<div class="row data-type">
						...
						<div class="col-md-4 data">
							<input type="text" class="form-control disabled" name="id"
								placeholder="用户编号" value="${user.id}">
						</div>
						...
						<div class="col-md-2 title">用户电话</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="phoneNum"
								   placeholder="用户电话" value="${user.phoneNum}">
						</div>

						<div class="col-md-2 title">用户邮箱</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" placeholder="用户邮箱"
								   name="email" value="123 ${user.email}">
						</div>
